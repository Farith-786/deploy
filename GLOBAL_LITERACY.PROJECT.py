...
if st.sidebar.button("📤 Upload Sample Data"):
    # Insert sample data
    sample_data = [
        ("India", "2026-01-01", 8419600, 0.12, 11.2, 6.5, 3.2),
        ("India", "2026-02-01", 8423800, 0.14, 11.5, 6.3, 3.5),
        ("Los Angeles", "2026-01-01", 3980400, 0.08, 10.8, 7.2, 2.1),
        ("Los Angeles", "2026-02-01", 3985400, 0.10, 11.0, 7.0, 2.3),
        ("Chicago", "2026-01-01", 2716000, 0.05, 10.2, 8.1, 1.5),
        ("Chicago", "2026-02-01", 2719000, 0.07, 10.4, 8.0, 1.7)
    ]
...
# --------------------- VISUALIZATION PAGE ---------------------
    ...
    if df.empty:
        ...
        chart_type = st.selectbox(
            "Select Chart Type",
            ["Line Chart", "Bar Chart", "Area Chart", "Scatter Plot", "Multi-Line Chart"]
        )
        ...
        metrics = st.multiselect(
            ...
            default=['Growth_Rate', 'Birth_Rate']
        )
...
st.markdown(
    ...
    <div style="text-align: center; color: #666; padding: 20px;">
        <p>© 2026 Growth Population Analysis | Built with ❤️ using Streamlit</p>
    </div>
    """,
    unsafe_allow_html=True
)
